...
- One can explore the algorithms and their parameters in the provided jupyter notebooks `<algorithm-name>_example.ipynb`:
  - [Bose](bose_example.ipynb)
  - [Martjushev](martjushev_example.ipynb)
  - [ProDrift](prodrift_example.ipynb)
  - [Earth Mover's Distance](earthmover_example.ipynb)
  - [Process Graph Metrics](process_graph_example.ipynb)
  - [Zheng](zheng_example.ipynb)
# Usage #
...
log = xes_importer.apply(PATH_TO_LOG) # Import the Log
...
- Apply the full pipeline with:
```python
import processGraphMetrics as pgm
from pm4py.objects.log.importer.xes import importer as xes_importer
log = xes_importer.apply(PATH_TO_LOG) # Import the Log
